        ...
        <div class="register-form-box">
            <div class="register-form-content">
                <div class="register-form-left">
                    ...
                    <form action="">
                        <div class="register-form-step active" id="step-1">
                            <h2>Información Personal</h2>
                            <p>Introduce tus datos personales correctamente</p>
                            <div>
                                <label>Nombre</label>
                                <input type="text" placeholder="p. ej. Enrique">
                            </div>
                            <div>
                                <label>Apellido</label>
                                <input type="text" placeholder="p. ej. Gaytán">
                            </div>
                            <div class="birth">
                        ...
                        <div class="register-form-step" id="step-2">
                            <h2>Contacto</h2>
                            <div>
                                <label>Teléfono</label>
                                <input type="tel" placeholder="+525555555555">
                            </div>
                            <div>
                        ...
                        <div class="register-form-step" id="step-3">
                            <h2>Seguridad</h2>
                            <div>
                                <label>Email</label>
                        ...
                        <button type="submit" class="register-btn-submit">Registrarse</button>
                    </form>
                </div>
            </div>
        </div>
